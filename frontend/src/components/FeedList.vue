    ...
    <div class="feed-card-body">
      ...
      <div class="card-content">
        <p> {{ i.content.slice(0, 90) }}
          <span v-if="i.content.length > 100" class="more cursor-p" id="more" @click="openModal">
            ... 더보기
          </span>
        </p>
      </div>
      ...
      <div class="card-btn">
        <div>
          ...
          <div class="comment">
            <img class="cursor-p" src="../img/Feed/comment.png" id="comment" @click="openModal"/>
            <span @click="openModal" class="cursor-p">{{ i.comments }}</span>
          </div>
        </div>
