  ...
  <div class="reg-container">
    ...
    <div class="reg-box">
      <div class="reg-box-card">
        ...
        <div class="reg-info">
          <div class="reg-info-box">
            <img src="../img/FaceRegistration/image3-unscreen.gif" width="200">
            <div class="reg-desc">
              <div class="reg-title">
                <span class="desc-title">지금의 나를 남겨 주세요!</span>
              </div>
        ...
        <div class="input-area">
          <div class="input-pic-box upload-grid"
            ...
            <div class="upload-area-container">
              ...
              <div class="upload-area-box3">
                <label for="upload-btn" id="upload-btn-label">얼굴 등록하기</label>
                <input type="file" id="upload-btn" @change="fileChanged"/>
              </div>
            </div>
          </div>
          <!--업로드 시킬 영역-->
          <div class="input-pic-box img-upload-area"
      ...
      <div class="next-button">
        <button id="preStep" @click="slideCard">다음단계</button>
      </div>
    </div>
    <!-- 카드 영역 끝 1-->
    ...
    <div class="reg-box">
      <div class="reg-box-card">
        ...
        <div class="reg-info">
          <div class="reg-info-box">
            <img src="../img/FaceRegistration/darily--unscreen.gif" width="300">
            <div class="reg-desc">
              <div class="reg-title">
                <span class="desc-title">지금의 나를 기록해 주세요!</span>
              </div>
...
=======
      ...
      <div class="next-button">
        ...
        <button  @click="slideCard">일기쓰기</button>
      </div>
    </div>
    <!-- 카드 영역 끝 2 -->
...
=======
      ...
      <div class="next-button">
        <button @click="returnCard">이전단계</button>
        <button  @click="submitCard">분석하기</button>
        <a href="/Total_stress">분석 임시 페이지 버튼</a>
          ...
          <div
            ...
            <div class="modal-container1">
              <div class="warn-modal-btn">
                <button id="warn_modal_close"
                        @click="modal_click"></button>
              </div>
              <div class="warn-info">
                ...
                <div class="info-cards-container">
                  <div class="info-cards-1 card">
                    <img src="../img/FaceRegistration/warn_info_img/image 79.png" width="60"/>
                    <img
                  ...
                  <div class="info-cards-3 bcard">
                    ...
                    <img
                        ...
                        width="100"
                        height="130"/>
                    <span class="info-coment" style="color: white">사진이 어둡게 나온 경우</span >
                  </div>
...
=======
  ...
  methods : {
    ...
    submitCard(){
      ...
      // 일기
      this.formData.append('title', document.getElementById('diary-title').value);
      // 일기 내용
      this.formData.append('content', document.getElementById('diary-content').value);
      // 일기 날짜
      this.formData.append('date', document.getElementById('diary-date-h1').innerText);
